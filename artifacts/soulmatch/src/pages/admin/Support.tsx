      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Inbox className="h-4 w-4 text-[#707070]" />
          </CardHeader>
          <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                {messages?.map((msg: any) => (
                  <TableRow key={msg.id}>
                    ...
                    <TableCell>
                      ...
                      <div className="text-sm text-[#707070]">{msg.email}</div>
                    </TableCell>
                ...
                {(!messages || messages.length === 0) && (
                  <TableRow>
                    <TableCell colSpan={5} className="text-center py-6 text-[#707070]">
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="my-6 space-y-4">
            ...
            {selectedMessage?.status === "resolved" && (
              <div className="text-sm text-[#707070] flex items-center">
