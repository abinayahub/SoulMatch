  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* System Status */}
        <div className="bg-[#FFFFFF] shadow-sm rounded-2xl p- border border-[#E5E7EB]">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-[#6B7280] text-sm">API Server</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-[#6B7280] text-sm">Database</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-[#6B7280] text-sm">Compatibility Engine</span>
            ...
            <div className="pt-4 border-t border-[#E5E7EB]">
              <Button className="w-full bg-[#F3F4F6] hover:bg-[#F3F4F6]" variant="ghost" onClick={() => handleAction('Run Diagnostics')}>
        ...
        <div className="bg-[#FFFFFF] shadow-sm rounded-2xl p- border border-[#E5E7EB]">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center bg-[#FFFFFF] shadow-sm rounded-lg p-3 border border-[#E5E7EB]">
              <div>
                <div className="font-medium text-sm">Maintenance Mode</div>
                <div className="text-xs text-[#6B7280]">Disable app access for users</div>
              </div>
              <Button 
            ...
            <div className="bg-[#FFFFFF] shadow-sm rounded-lg p-3 border border-[#E5E7EB] space-y-2">
        ...
        <div className="bg-card border border-border shadow-md rounded-2xl rounded-2xl border border-red-500/30 p-6 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="pt-2">
              <Button className="w-full bg-red-600 hover:bg-red-700 text-[#111827]" onClick={() => handleAction('Wipe Test Data')}>
