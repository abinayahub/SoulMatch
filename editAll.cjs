...
// ==========================================
// 1. Merge Personality Match & Values Match 
// ==========================================
...
// ==========================================
// 2. Merge Profile Card & Profile Comparison
// ==========================================
...
// In compJSX, we need to remove </Popover> ending or adjust it.
// Wait, the compJSX has `</Popover>` in it? The previous script did this:
...
// This was specifically targeted for the `Profile Comparison` header and popover which we wanted to delete.
// Let's keep it to delete the header and popover:
const popoverEnd = compJSX.indexOf('</Popover>');
if (popoverEnd !== -1) {
    compJSX = compJSX.substring(popoverEnd + 10);
}
const firstDivEnd = compJSX.indexOf('</div>');
if (firstDivEnd !== -1) {
    compJSX = compJSX.substring(firstDivEnd + 6);
}
